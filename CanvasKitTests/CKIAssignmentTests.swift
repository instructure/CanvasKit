...
class CKIAssignmentTests: XCTestCase {
    ...
    func testJSONModelConversion() {
        ...
        var url = NSURL.URLWithString("http://canvas.example.com/courses/123/assignments/4")
        ...
        XCTAssertEqual(assignment.needsGradingCount, 17, "Assignment needsGradingCount did not parse correctly")
