...
+ (void)fetchFolder:(NSString *)folderID success:(void (^)(CK2Folder *))success failure:(void (^)(NSError *))failure
{
    ...
    [[CK2Client currentClient] fetchModelAtPath:path parameters:nil modelClass:[CK2Folder class] context:nil success:(void (^)(CK2Model *))success failure:failure];
}
...
- (void)fetchFoldersWithSuccess:(void (^)(CK2PagedResponse *))success failure:(void (^)(NSError *))failure
{
    ...
    [[CK2Client currentClient] fetchPagedResponseAtPath:path parameters:nil modelClass:[CK2Folder class] context:self success:success failure:failure];
}
...
- (void)fetchFilesWithSuccess:(void (^)(CK2PagedResponse *))success failure:(void (^)(NSError *))failure
{
    ...
    [[CK2Client currentClient] fetchPagedResponseAtPath:path parameters:nil modelClass:[CK2File class] context:self success:success failure:failure];
}
