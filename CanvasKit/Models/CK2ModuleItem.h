...
/**
 ...
 @see CK2File
 */
extern NSString * const CK2ModuleItemTypeFile;
...
/**
 ...
 @see CK2Page
 */
extern NSString * const CK2ModuleItemTypePage;
...
/**
 ...
 @see CK2Dicussion
 */
extern NSString * const CK2ModuleItemTypeDiscussion;
...
/**
 ...
 @see CK2Assignment
 */
extern NSString * const CK2ModuleItemTypeAssignment;
...
/**
 ...
 @see CK2Quiz.
 */
extern NSString * const CK2ModuleItemTypeQuiz;

/**
 The module item is a text subheader describing a subsection
 in a module.
 */
extern NSString * const CK2ModuleItemTypeSubHeader;

/**
 The module item is a URL to another web page.
 */
extern NSString * const CK2ModuleItemTypeExternalURL;

/**
 The module item is a URL to an LTI tool.
 */
extern NSString * const CK2ModuleItemTypeExternalTool;

/**
 Must view the item to fulfill completion requirement.
 */
extern NSString * const CK2ModuleItemCompletionRequirementMustView;
/**
 Must make a submission to fulfill completion requirement.
 */
extern NSString * const CK2ModuleItemCompletionRequirementMustSubmit;
/**
 Must contribute to fulfill completion requirement.
 */
extern NSString * const CK2ModuleItemCompletionRequirementMustContribute;
/**
 Must achieve a minimum score to fulfill completion requirement.
 
 @see minimumScore
 */
extern NSString * const CK2ModuleItemCompletionRequirementMinimumScore;

/**
 An individual item inside a CK2Module. Can be a file, wiki page,
 discussion, assignment, quiz, text subheader, external URL, or
 external LTI tool.
 */
@interface CK2ModuleItem : CK2Model
...
/**
 ...
 @see CK2ModuleItemCompletionRequirementMustView
 CK2ModuleItemCompletionRequirementMustSubmit
 CK2ModuleItemCompletionRequirementMustContribute
 CK2ModuleItemCompletionRequirementMinimumScore
 @see minimumScore if this is a CK2ModuleItemCompletionRequirementMinimumScore
 */
