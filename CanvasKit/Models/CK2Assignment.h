...
@class CK2Course;
@interface CK2Assignment : CK2LockableModel
...
//@property (nonatomic, copy) CK2Submission *submission;
...
#pragma mark - CK2Model
/** @name CK2Model Overrides. */

/**
 The context for an assignment is a CK2Course object. This override
 is a convenience and merely adds the type of the context back in.
 */
@property (nonatomic, readonly) CK2Course *context;
