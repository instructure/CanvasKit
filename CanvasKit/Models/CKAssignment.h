...
@class CKCourse;
@interface CKAssignment : CKLockableModel
...
//@property (nonatomic, copy) CKSubmission *submission;
...
#pragma mark - CKModel
/** @name CKModel Overrides. */

/**
 The context for an assignment is a CKCourse object. This override
 is a convenience and merely adds the type of the context back in.
 */
@property (nonatomic, readonly) CKCourse *context;
