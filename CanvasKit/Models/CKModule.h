 ...
 */
extern NSString * const CKModuleStateLocked;
/**
 The module is in an unlocked, but not yet started state.
 */
extern NSString * const CKModuleStateUnlocked;
/**
 The module is unlocked and some progress has been made.
 */
extern NSString * const CKModuleStateStarted;
/**
 All requirements in the module have been completed.
 */
extern NSString * const CKModuleStateCompleted;

/**
 The current workflow of the module is active.
 */
extern NSString * const CKModuleWorkflowStateActive;
/**
  The current workflow of the module is deleted.
 */
extern NSString * const CKModuleWorkflowStateDeleted;

@interface CKModule : CKModel
...
/**
 ...
 @see CKModuleWorkflowStateActive, CKModuleWorkflowStateDeleted
 */
...
/**
 The module's items. An array of CKModuleItem.
