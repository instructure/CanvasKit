 ...
 */
@interface CKRubricCriterion : CKModel
...
/**
 Array of CKRubricCriterionRating for this criterion.
 */
 ...
 */
@property (nonatomic, readonly) CKRubricCriterionRating *selectedRating;
