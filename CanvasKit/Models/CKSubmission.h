...
extern NSString * const CKSubmissionTypeOnlineTextEntry;
extern NSString * const CKSubmissionTypeOnlineURL;
extern NSString * const CKSubmissionTypeOnlineUpload;
extern NSString * const CKSubmissionTypeMediaRecording;

@interface CKSubmission : CKModel
...
/**
 ...
 @see CKSubmissionTypeOnlineTextEntry, CKSubmissionTypeOnlineURL,
 CKSubmissionTypeOnlineUpload, CKSubmissionTypeMediaRecording
 */
...
/**
 Comments left by graders. An array of CKSubmissionComment objects.
 */
